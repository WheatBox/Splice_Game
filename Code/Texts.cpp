...
#define __TEXT(chinese, english) gTexts.push_back(Frame::UTF8Utils::ToUnicode(language == ELanguage::Chinese ? chinese : english));
		...
		__TEXT("[4] - 更改配色", "[4] - Change colors"); // EditorToolSwatches
		__TEXT("[5] - 编辑控制器", "[5] - Edit controller"); // EditorToolController

		__TEXT("[鼠标中键] - 移动视图，[鼠标滚轮] - 缩放视图，[1~5] - 切换工具", "[Mouse Middle Button] or [W/A/S/D] - Move view, [Move Scroll Wheel] - Zoom view, [1~5] - Switch tool"); // EditorOperationPrompt_Camera
